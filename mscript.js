...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    function dexterityMobileMenu() {
      ...
      // open sub-level
      $(".dexterity-navbar-mobile li.dropdown > a").append(
        "<span class='dropdown-toggle' data-toggle='dropdown'></span>"
      );
      $(".dexterity-navbar-mobile li.dropdown > a .dropdown-toggle").on(
        "click",
        function (e) {
          e.preventDefault();
          e.stopPropagation();
...
if (mapId || contactMapId || servicesMapId) {
  function initMap() {
    ...
    var servicesLocation = {
      lat: 5.600496038453617,
      lng: -0.17748180701564314,
    };
